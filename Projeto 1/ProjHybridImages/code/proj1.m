...
% Carrega a imagem e converte ela para float

image1 = im2single(imread('../data/num2.jpg'));
image2 = im2single(imread('../data/num1.jpg'));
...
% cutoff_frequency eh o desvio padrao do Gaussiano que ira remover o bluir das altas
% frequencias
cutoff_frequency = 7;
[hybrid_image,low_frequencies,high_frequencies] = gen_hybrid_image( image1, image2, cutoff_frequency );

%% Visualize and save outputs
% Visualiza e salva as saidas
